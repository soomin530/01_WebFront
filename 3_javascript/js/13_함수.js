...
btn1.addEventListener("click", function() {
  ...
  print1(value, result);
  // print1(result, value); - 순서가 바뀌면 다른 뜻이 되기 때문에 순서가 매우 중요

}); 


// ctrl 누르고 함수명 누르면 이 함수가 어디서 선언됐는지 바로 체크 가능 !
...
function returnTest(num1, num2) {
  return num1 * num2; // 함수를 종료 + return 옆에 작성된 값을 가지고
                      // 호출한 쪽으로 돌아감
}
...
function printObject( otherFn ) { 
  ...
  */
  ...
  consol.log(otherFn("홍길동", 20)); // {"name" : 홍길동, "age" : 20}
}
